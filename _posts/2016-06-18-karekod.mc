...
Öncelikle linki belirliyoruz.Ardından linki kopyalıyoruz.Tarayıcımızdan https://www.the-qrcode-generator.com/ adresine gidiyoruz.Belirlediğimiz linki açılan sitedeki URL kısmına yapıştırıyoruz.Karşınızda yeni kare kodunuz.
